...
class BarItemsControllerTest < ActionController::TestCase
  ...
  test "should create bar_item" do
    assert_difference('BarItem.count') do
      post :create, bar_item: { bar_closeout: @bar_item.bar_closeout, bar_menu_item_id: @bar_item.bar_menu_item_id, ticket_id: @bar_item.ticket_id }
    end
  ...
  test "should update bar_item" do
    patch :update, id: @bar_item, bar_item: { bar_closeout: @bar_item.bar_closeout, bar_menu_item_id: @bar_item.bar_menu_item_id, ticket_id: @bar_item.ticket_id }
    assert_redirected_to bar_item_path(assigns(:bar_item))
  end
